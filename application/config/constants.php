...
defined('PROJECT_NAME')        OR define('PROJECT_NAME','DREAM TOUCH'); 
...
defined('SITE_SALT')           OR define('SITE_SALT',"MLM Template");
...
/*--------------Template Colors-------------*/
//////////////////////////////////////////////
defined('ACCENT_COLOR')        OR define('ACCENT_COLOR',"accent-gray");
defined('NAVBAR_COLOR')        OR define('NAVBAR_COLOR',"navbar-dark navbar-lite-green");
defined('BRAND_COLOR')         OR define('BRAND_COLOR',"navbar-dark");
defined('SIDEBAR_COLOR')       OR define('SIDEBAR_COLOR',"sidebar-dark-green lite-green");
//////////////////////////////////////////////
...
if(isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST']=='localhost'){
	...
	defined('DB_NAME')		? null : define('DB_NAME','db_dream_touch');
}
else{
	defined('DB_HOST')      ? null : define('DB_HOST', 'localhost');
