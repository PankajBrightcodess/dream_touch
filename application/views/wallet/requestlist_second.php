                                    ...
                                    <table class="table data-table" id="bootstrap-data-table-export">  
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                <td>
                                                    <form action="<?php echo base_url('wallet/approvepayout_second'); ?>" method="post" onSubmit="return validate('accept');" class="float-left" style="margin-right:5px;">
                                                        <button type="submit" value="<?php echo $member['id'] ?>" name="request_id" class="btn btn-sm btn-success">Approve</button>
                                                    </form>
                                                    <form action="<?php echo base_url('wallet/rejectpayout_second'); ?>" method="post" onSubmit="return validate('reject');" class="float-left">
