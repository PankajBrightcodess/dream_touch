            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-5">
                                <?php echo form_open('profile/updatetranspassword','onSubmit="return checkPassword(\'form\');"'); ?>
                                <div class="devit-card-custom">
                                    <div class="form-group">
                                        <?php 
                                            $attributes=array("id"=>"oldpass","Placeholder"=>"Old Password");
                                            echo create_form_input("password","oldpass","Old Transcation Password",true,'',$attributes); 
                                        ?>
                                    </div>
                                    <div class="form-group">
                                        <?php 
                                            $attributes=array("id"=>"password","Placeholder"=>"New Password");
                                            echo create_form_input("password","password","New Transcation Password",true,'',$attributes); 
                                        ?>
                                    </div>
                                    <div class="form-group">
                                        <?php 
                                            $attributes=array("id"=>"retype","Placeholder"=>"Confirm Password");
                                            echo create_form_input("password","","Confirm Transcation Password",true,'',$attributes); 
                                        ?>
