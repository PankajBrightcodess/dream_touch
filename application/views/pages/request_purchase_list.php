                                            ...
                                            if(!empty($purchase_list)){
                                                ...
                                                foreach ($purchase_list as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php if(!empty($value['purchase_screen_shot'])){ echo '<img src="'.base_url($value['purchase_screen_shot']).'" alt="payment" width="120" height="70">'; }else{ echo '<img src="'.base_url('assets/images/imageavailable.jpg').'" alt="Girl in a jacket" width="120" height="70">'; }?></td> 
                                                        <td><?php echo date('d-m-Y',strtotime($value['added_on']));?></td>  
                                                        <td>
                                                    <form action="<?php echo base_url('members/approvepurchase'); ?>" method="post" onSubmit="return validate('accept');" class="float-left" style="margin-right:5px;">
                                                        <button type="submit" value="<?php echo $value['id'] ?>" name="request_id" class="btn btn-sm btn-success">Approve</button>
                                                    </form>
                                                    <form action="<?php echo base_url('members/rejectpurchase'); ?>" method="post" onSubmit="return validate('reject');" class="float-left">
                                                        <button type="submit" value="<?php echo $value['id'] ?>" name="request_id" class="btn btn-sm btn-danger">Reject</button>
                                                    </form>
                                                </td>
