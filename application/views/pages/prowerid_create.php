                ...
                <div class="card">
                    ...
                    <div class="row">
                            <div class="col-md-4 col-sm-12 col-lg-3">
                                <?php echo form_open_multipart('powerid-submit');?>
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <div class="col-sm-12 col-lg-12 col-md-12">
                                        <?php echo form_input(array('type'=>'number','name'=>'iv','id'=>'iv','class'=>'form-control','placeholder'=>'Enter IV','required'=>'true'));?>
