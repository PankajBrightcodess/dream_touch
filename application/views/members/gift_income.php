                                ...
                                <div class="table-responsive" id="result">
                                    <table class="table table-striped data-table" id="bootstrap-data-table-export">
                                        ...
                                        <tr>
                                            ...
                                            <th><span class="badge badge-lg rounded-pill bg-success p-2">SUN</span></th>
                                            <th class="select-filter text-bold"><img height="150px" width="150px" src="<?php echo base_url('assets/images/01.png');?>"><p>DIARY PEN</p> </th>
                                        ...
                                        <tr>
                                            ...
                                            <th><span class="badge badge-lg rounded-pill bg-success p-2">GOLD</span></th>
                                            <th class="select-filter text-bold"><img height="150px" width="150px" src="<?php echo base_url('assets/images/02.png');?>"><p>WALL WATCH</p> </th>
                                            <th class="select-filter text-bold">
                                                 <?php
                                        ...
                                        <tr>
                                            ...
                                            <th><span class="badge badge-lg rounded-pill bg-success p-2">PLATINUM</span></th>
                                            <th class="select-filter text-bold"><img height="150px" width="150px" src="<?php echo base_url('assets/images/03.png');?>"><p>T-SHIRT</p> </th>
                                            <th class="select-filter text-bold">
                                                 <?php
                                        ...
                                        <tr>
                                            ...
                                            <th><span class="badge badge-lg rounded-pill bg-success p-2">RUBY</span></th>
                                            <th class="select-filter text-bold"><img height="150px" width="150px" src="<?php echo base_url('assets/images/04.png');?>"><p>SHIRT PANT</p> </th>
                                            <th class="select-filter text-bold">
                                                 <?php
                                        ...
                                        <tr>
                                            ...
                                            <th><span class="badge badge-lg rounded-pill bg-success p-2">DIAMOND</span></th>
                                            <th class="select-filter text-bold"><img height="150px" width="150px" src="<?php echo base_url('assets/images/05.png');?>"><p>COAT PANT</p> </th>
                                            <th class="select-filter text-bold">
                                                 <?php
                                        ...
                                        <tr>
                                            ...
                                            <th><span class="badge badge-lg rounded-pill bg-success p-2">WHITE DIAMOND</span></th>
                                            <th class="select-filter text-bold"><img height="150px" width="150px" src="<?php echo base_url('assets/images/06.png');?>"><p>COAT PAND + HAND WATCH</p> </th>
                                            <th class="select-filter text-bold">
                                                 <?php
