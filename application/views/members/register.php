...
<section class="content" style="height:100%; background: linear-gradient(302deg,#ff963c78,#fff,#6ccda0,#8bb4fe); background-repeat: no-repeat; background-size: cover; repeat-y; height:150vh; ">
<!-- background: linear-gradient(180deg,#07232e,#68949a) repeat-y; height:120vh; -->
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-12">
                                 <?php echo form_open_multipart('members/addmember', 'id="myform" onsubmit="return validate()"'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            <span class="text-bold mb-5">District <sapn class="text-danger">*</sapn></span>
                        ...
                        <!-- <div id="dot-loader" class="hidden"><img src="<?php echo file_url('assets/images/dotsloader.gif'); ?>" alt="" ></div> -->
                    </div>
                </div>
                <!-- <br>
<br>
