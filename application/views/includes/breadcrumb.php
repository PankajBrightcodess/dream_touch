					...
					<?php
                        if(!empty($breadcrumb) && is_array($breadcrumb)){
                            ...
                            foreach($breadcrumb as $link=>$crumb){
                                if($link=='active'){
                                    echo '<li class="breadcrumb-item active text-light" aria-current="page">'.$crumb.'</li>';
                                }
                                elseif($link==''){
                                    echo '<li class="breadcrumb-item text-light" >'.$crumb.'</li>';
                                }
                                else{
                                    echo '<li class="breadcrumb-item text-light"><a href="'.base_url($link).'">'.$crumb.'</a></li>';
                                }
                            }	
                        }
                    ?>
